...
T: dict[str, dict[str, str]] = {
    ...
    "uk": {
        ...
        "start.plan_free": "🌱 Безкоштовний пакет — 10 слів/день. /premium щоб 100.",
        "start.plan_expired": "⛔️ Trial закінчився. Збери ще {xp_left} XP для безкоштовного пакету або /buy для Pro.",
        ...
        "limit.expired": "⛔️ Trial закінчився.\n\n💎 <b>Pro</b> — 100 слів/день за $1.49/міс. /buy\n\n🎯 Або назбирай <b>{threshold} XP</b> — і отримаєш безкоштовний пакет 10 слів/день назавжди.\nЗараз у тебе: {xp} XP.",
    ...
    "en": {
        ...
        "start.plan_free": "🌱 Free package — 10 words/day. /premium to unlock 100.",
        "start.plan_expired": "⛔️ Trial is over. Earn {xp_left} more XP for the free package, or /buy for Pro.",
        ...
        "limit.expired": "⛔️ Trial is over.\n\n💎 <b>Pro</b> — 100 words/day at $1.49/mo. /buy\n\n🎯 Or earn <b>{threshold} XP</b> — and you'll unlock the free 10/day package forever.\nYou have: {xp} XP.",
    ...
    "es": {
        ...
        "start.plan_free": "🌱 Paquete gratuito — 10 palabras/día. /premium para 100.",
        "start.plan_expired": "⛔️ Trial terminado. Junta {xp_left} XP más para el paquete gratuito o /buy para Pro.",
        ...
        "limit.expired": "⛔️ Trial terminado.\n\n💎 <b>Pro</b> — 100 palabras/día por $1.49/mes. /buy\n\n🎯 O junta <b>{threshold} XP</b> y desbloqueas el paquete gratuito de 10/día para siempre.\nTienes: {xp} XP.",
    ...
    "pl": {
        ...
        "start.plan_free": "🌱 Pakiet darmowy — 10 słów/dzień. /premium żeby 100.",
        "start.plan_expired": "⛔️ Trial się skończył. Zbierz jeszcze {xp_left} XP do darmowego pakietu lub /buy dla Pro.",
        ...
        "limit.expired": "⛔️ Trial się skończył.\n\n💎 <b>Pro</b> — 100 słów/dzień za $1.49/mc. /buy\n\n🎯 Albo zbierz <b>{threshold} XP</b> — i odblokowujesz pakiet darmowy 10/dzień na zawsze.\nMasz: {xp} XP.",
    ...
    "de": {
        ...
        "start.plan_free": "🌱 Gratispaket — 10 Wörter/Tag. /premium für 100.",
        "start.plan_expired": "⛔️ Trial vorbei. Sammle noch {xp_left} XP für das Gratispaket oder /buy für Pro.",
        ...
        "limit.expired": "⛔️ Trial ist vorbei.\n\n💎 <b>Pro</b> — 100 Wörter/Tag für $1.49/Mon. /buy\n\n🎯 Oder sammle <b>{threshold} XP</b> — und du schaltest das Gratispaket 10/Tag für immer frei.\nDu hast: {xp} XP.",
